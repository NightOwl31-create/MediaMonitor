...
<p align="center">
  ...
  <img src="playstore/playstore-01-sessions-actives.jpg" alt="Live sessions" width="220" />
  <img src="playstore/playstore-02-choose-servers.jpg" alt="Choose servers" width="220" />
</p>
<p align="center">
  <img src="playstore/playstore-03-onboarding-langues.jpg" alt="Language selector" width="220" />
  <img src="playstore/playstore-04-historique.jpg" alt="History" width="220" />
  <img src="playstore/playstore-05-serveurs-bibliotheques.jpg" alt="Servers and libraries" width="220" />
</p>
<p align="center">
...
- [Privacy policy](PRIVACY.md) — what is stored, where, and why
- [Security policy](SECURITY.md) — how to report a vulnerability
- [Changelog](CHANGELOG.md) — release notes

## Contact

For general questions or feedback, open an [issue](https://github.com/NightOwl31-create/MediaMonitor/issues). For security vulnerabilities, please follow the [security policy](SECURITY.md).
